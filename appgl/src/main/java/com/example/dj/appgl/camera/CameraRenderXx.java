...
public class CameraRenderXx implements GLSurfaceView.Renderer, Preview.OnPreviewOutputUpdateListener,SurfaceTexture.OnFrameAvailableListener {
    ...
    public CameraRenderXx(CameraFilterGLSurface cameraView,Context context) {
...
//        int textureProcessedId = filterChain.proceed(texture[0]);
        cameraFilter.onDraw(texture[0],filterChain);
        //录制
