...
public class CameraOneRender implements GLSurfaceView.Renderer {
    ...
    public CameraOneRender(Context mContext, SurfaceTexture.OnFrameAvailableListener listener) {
